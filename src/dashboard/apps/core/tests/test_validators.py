...
@pytest.mark.parametrize(
    "value",
    ["12345", "12345Z", "123A", "12A45", "ABC1Z", "1234!", "abcdA", "1234", "", 12345],
)
...
@pytest.mark.parametrize("value", ["12345", "98765", "00000", None])
...
@pytest.mark.parametrize("value", ["1234", "123456", "12a45", "abcde", "", " ", 12345])
