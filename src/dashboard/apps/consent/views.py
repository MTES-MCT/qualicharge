...
class ConsentFormView(BaseView, FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["consents"] = entity.get_awaiting_consents_stations_grouped()
...
class ValidatedConsentView(BaseView, ListView):
    ...
    def get_queryset(self) -> Any:
        ...
        return entity.get_validated_consents_stations_grouped()
...
class UpcomingConsentFormView(ConsentFormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        """
        context = super().get_context_data(**kwargs)
        context["consents"] = context["entity"].get_upcoming_consents_stations_grouped()
